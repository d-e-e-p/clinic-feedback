...
const SESSION_DURATION = 0.2 * 60 * 1000;
// API key for the SoulMachines SDK (this key will be used by smwebsdk)
const apiKey =
  "eyJzb3VsSWQiOiJkZG5hLWJhci1vZi1zb2FwNTY4Zi0tc3VydmV5MSIsImF1dGhTZXJ2ZXIiOiJodHRwczovL2RoLnNvdWxtYWNoaW5lcy5jbG91ZC9hcGkvand0IiwiYXV0aFRva2VuIjoiYXBpa2V5X3YxXzhkMjFmNTgxLTA4Y2NlLTRjNC1hYzkzLTZjZTUxMzFhNmRlOSJ9";
...
async function disconnectSession(isTimeExpired = false) {
  ...
  if (!isTimeExpired) {
    thankYouScreen.querySelector("p").textContent =
      "Session manually ended. Redirecting to the main page...";
  }
...
async function connect() {
  ...
  if (typeof smwebsdk === "undefined" || !smwebsdk.Scene) {
    statusElement.textContent =
      "Error: SoulMachines SDK (smwebsdk.min.js) not loaded.";
    return;
  }
  ...
  try {
    ...
    statusElement.textContent =
      'Connected. Click "Start Video" to begin session.';
